 ...
 * generated in the com.uwefuchs.demo.soap.apachecxf.endpoint package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudents_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "getStudents");
    private final static QName _GetStudentsResponse_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "getStudentsResponse");
    private final static QName _Hello_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "hello");
    private final static QName _HelloResponse_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "helloResponse");
    private final static QName _HelloStudent_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "helloStudent");
    private final static QName _HelloStudentResponse_QNAME = new QName("http://endpoint.apachecxf.soap.demo.uwefuchs.com/", "helloStudentResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.uwefuchs.demo.soap.apachecxf.endpoint
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "getStudents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "getStudentsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "helloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "helloStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoint.apachecxf.soap.demo.uwefuchs.com/", name = "helloStudentResponse")
